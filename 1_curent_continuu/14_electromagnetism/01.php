...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="ro" > 
  <head>
    ...
    <title>Magneţi permanenţi</title>
  </head>
<body>
  <div id="meniu">
...
<div id="contents">
<p>Faptul că unele tipuri de roci minerale posedă proprietăţi neobişnuite de atracţie atunci când se află în apropierea fierului, a fost descoperit cu secole în urmă. Una dintre aceste minerale speciale, <i>magnetul natural</i> sau <i>magnetitul</i>, este menţionat cu aproximativ 2500 de ani în urmă în Europa şi chiar mai devreme în Orientul Îndepărtat ca şi subiect de curiozitate. Mai târziu este folosit în navigaţie, utlizând descoperirea că o bucată din acest material neobişnuit tinde să se orienteze pe direcţia nord-sud dacă este lăsat să se rotească liber (suspendat la capătul unui fir sau plutind pe apă). În 1269, Peter  Peregrinus întreprinde un studiu ştiinţific ce arată că şi fierul poate fi „încărcat” în mod similar cu această proprietate prin frecarea acestuia de unul dintre „polii” magnetului.</p>
...
<p>Teoria modernă a magnetismului susţine că producerea câmpului magnetic se datorează sarcinii electrice aflate în mişcare; acest lucru ar însemna că acest câmp magnetic „permanent” al magneţilor este de fapt rezultatul mişcării uniforme în aceeiaşi direcţie a electronilor din interiorul atomilor de fier. Un asfel de comportament al electronilor în interiorul atomilor depinde de structura atomica a fiecărui material în parte. Asfel, doar anumite tipuri de substanţe reacţionează cu câmpurile magnetice, şi un număr şi mai mic dintre ele posedă abilitatea de susţinere a unui câmp magnetic permanent.</p>
...
<ul>
	<li><i>Magnetul natural</i> sau <i>magnetitul</i> este un magnet permanent natural. Prin permanent se înţelege faptul că materialul poate menţine câmpul magnetic fără niciun ajutor extern. Proprietatea oricărui material magnet de a realiza acest lucru se numeşte <i>remanenţă</i></li>
	<li>Materialele <i>feromagnetice</i> sunt uşor de magnetizat</li>
	<li>Materialele <i>paramagnetice</i> sunt mai greu de magnetizat</li>
	<li>Materialele <i>diamagnetice</i> tind să respingă câmpurile magnetice prin magnetizarea în direcţie opusă</li>
</ul>
</div>
<div id="footer">
