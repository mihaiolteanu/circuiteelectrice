...
:PROPERTIES:
:CUSTOM_ID: electricitate-statica
:END:
...
:PROPERTIES:
:CUSTOM_ID: conductori-dielectrici-si-deplasarea-electronilor
:END:
...
:PROPERTIES:
:CUSTOM_ID: tensiunea-si-curentul
:END:
...
:PROPERTIES:
:CUSTOM_ID: tensiune-si-curent-intr-un-circuit-practic
:END:
...
:PROPERTIES:
:CUSTOM_ID: sensul-conventional-si-sensul-real-de-deplasare-al-electronilor
:END:
...
* Legea lui ohm
:PROPERTIES:
:CUSTOM_ID: legea-lui-ohm
:END:

** Relaţia dintre tensiune, curent şi rezistenţă
:PROPERTIES:
:CUSTOM_ID: relatia-dintre-tensiune-curent-si-rezistenta
:END:
...
#+CAPTION: cunoaştem tensiunea şi rezistenţa folosind legea lui Ohm
[[./poze/00033.png]]
...
#+CAPTION: cunoaştem tensiunea şi curentul folosind legea lui Ohm
[[./poze/00034.png]]
...
#+CAPTION: atunci când cunoaştem rezistenţa şi curentul folosind legea lui Ohm
[[./poze/00035.png]]
...
:PROPERTIES:
:CUSTOM_ID: puterea-in-circuitele-electrice
:END:
...
:PROPERTIES:
:CUSTOM_ID: calcularea-puterii-electrice
:END:
...
:PROPERTIES:
:CUSTOM_ID: conexiunea-unui-circuit
:END:
...
:PROPERTIES:
:CUSTOM_ID: polaritatea-caderilor-de-tensiune
:END:
...
* Electrocutarea
:PROPERTIES:
:CUSTOM_ID: electrocutarea
:END:

** Siguranţa în domeniul electric
:PROPERTIES:
:CUSTOM_ID: siguranta-in-domeniul-electric
:END:
...
:PROPERTIES:
:CUSTOM_ID: drumul-curentului-in-cazul-electrocutarii
:END:
...
#+CAPTION: atunci când fiecare dintre ele atunge un punct din circuit cu potenţial
...
:PROPERTIES:
:CUSTOM_ID: legea-lui-ohm-din-nou
:END:      
...
#+CAPTION: cu sursele de tensiune: curentul este limitat doar de rezistenţa
#+CAPTION: corpului
[[./poze/10029.png]]
...
[[./poze/00063.png]] 
#+CAPTION: persoanele ce poartă mănuşi şi încălţăminte de protecţie: curentul este
#+CAPTION: limitat acum de valoarea totală a rezistenţei din circuit
[[./poze/10030.png]]
...
#+CAPTION: de putere prin realizarea unei împământări temporare a părţii din
...
#+CAPTION: asigurarea suplimentară a unui circuit deconectat de la sursa
#+CAPTION: de putere prin realizarea unui scurt-circuit cu ajutorul unui conductor
...
:PROPERTIES:
:CUSTOM_ID: reactia-in-cazuri-de-urgenta
:END:
...
:PROPERTIES:
:CUSTOM_ID: surse-potentiale-de-pericol
:END:
...
#+CAPTION: ce se află între punctul de contact al liniei electrice şi punctul de
...
:PROPERTIES:
:CUSTOM_ID: proiectarea-aparatelor-electrice
:END:
...
#+CAPTION: reţeaua de alimentare - căderea de tensiune între carcasa metalică şi
...
#+CAPTION: conectarea unui aparat electric cu carcasă metalică la
#+CAPTION: reţeaua de alimentare; la contactul accidental dintre fază şi carcasa
#+CAPTION: metalică, există o cădere de tensiune potenţial periculoasă între
...
#+CAPTION: conectarea unui aparat electric cu carcasă metalică la
#+CAPTION: reţeaua de alimentare; la contactul accidental dintre neutru şi carcasa
#+CAPTION: metalică, nu există niciun pericol de electrocutare
[[./poze/00073.png]]
...
#+CAPTION: conectarea unui aparat electric cu carcasă metalică la
#+CAPTION: reţeaua de alimentare; inversarea polarităţii prizei înseamnă ca orice
#+CAPTION: fir care vine în contact cu carcasa prezintă un potenţial pericol de
...
#+CAPTION: conectarea unui aparat electric cu carcasă metalică la
#+CAPTION: reţeaua de alimentare; folosirea prizei cu împământare pentru
...
#+CAPTION: conectarea unui aparat electric cu carcasă metalică la
#+CAPTION: reţeaua de alimentare; diferenţa de curent între fază şi neutru în cazul
#+CAPTION: electrocutării
[[./poze/00077.png]]
...
#+CAPTION: conectarea unui aparat electric cu carcasă metalică la
#+CAPTION: reţeaua de alimentare; deschiderea automată a întrerupătorului în cazul
#+CAPTION: existenţei unei diferenţe prea mari între curenţii fazei şi al neutrului
[[./poze/00078.png]]

** Utilizarea aparatelor de măsură
:PROPERTIES:
:CUSTOM_ID: utilizarea-aparatelor-de-masura
:END:
...
#+CAPTION: folosit pentru măsurarea tensiunii; apariţia scurt-circuitului
[[./poze/00351.png]]
...
:PROPERTIES:
:CUSTOM_ID: aritmetica-notatiei-stiintifice
:END:
...
* Serie paralel
:PROPERTIES:
:CUSTOM_ID: serie-paralel
:END:

** Ce sunt circuitele „serie” şi „paralel”
:PROPERTIES:
:CUSTOM_ID: ce-sunt-circuitele-serie-si-paralel
:END:
...
:PROPERTIES:
:CUSTOM_ID: circuite-serie-simple
:END:
...
:PROPERTIES:
:CUSTOM_ID: circuite-paralel-simple
:END:
...
| Marime | R_{1} | R_{2} | R_{3} | Total | Unitate |
|--------+-------+-------+-------+-------+---------|
| E      |       |       |       |       | V       |
| A      |       |       |       |       | I       |
| R      |       |       |       |       | Ω       |
...
:PROPERTIES:
:CUSTOM_ID: aplicarea-corecta-a-legii-lui-ohm
:END:
...
:PROPERTIES:
:CUSTOM_ID: analiza-circuitelor-defecte
:END:
...
:PROPERTIES:
:CUSTOM_ID: construirea-circuitelor-rezistive-simple
:END:
...
:PROPERTIES:
:CUSTOM_ID: circuite-divizoare-de-tensiune.-potentiometrul
:END:
...
:PROPERTIES:
:CUSTOM_ID: legea-lui-kirchhoff-pentru-tensiune
:END:
...
:PROPERTIES:
:CUSTOM_ID: circuite-divizoare-de-curent
:END:
...
:PROPERTIES:
:CUSTOM_ID: legea-lui-kirchhoff-pentru-curent
:END:
...
* Combinatii
:PROPERTIES:
:CUSTOM_ID: combinatii
:END:

** Ce este un circuit serie-paralel
:PROPERTIES:
:CUSTOM_ID: ce-este-un-circuit-serie-paralel
:END:
...
:PROPERTIES:
:CUSTOM_ID: tehnici-de-analiza-a-circuitelor
:END:
...
* Aparate de masura
:PROPERTIES:
:CUSTOM_ID: aparate-de-masura
:END:

** Ce este un aparat de măsură
:PROPERTIES:
:CUSTOM_ID: ce-este-un-aparat-de-masura
:END:
...
:PROPERTIES:
:CUSTOM_ID: impactul-voltmetrului-asupra-circuitului
:END:
...
#+CAPTION: detector de nul realizat cu ajutorul unei perechi de căşti şi
#+CAPTION: un întrerupător; adăugarea în circuit a unui transformator
[[./poze/00426.png]]
...
:PROPERTIES:
:CUSTOM_ID: impactul-ampermetrului-asupra-circuitului
:END:
...
:PROPERTIES:
:CUSTOM_ID: ohmmetre-pentru-tensiuni-inalte
:END:
...
:PROPERTIES:
:CUSTOM_ID: terminali-tip-kelvin-si-rezistori-de-precizie
:END:
...
:PROPERTIES:
:CUSTOM_ID: circuite-in-punte-puntea-wheatstone-si-thomson
:END:
...
:PROPERTIES:
:CUSTOM_ID: realizarea-practica-a-rezistentelor-de-calibrare
:END:
...
:PROPERTIES:
:CUSTOM_ID: sisteme-cu-semnale-de-tensiune
:END:
...
:PROPERTIES:
:CUSTOM_ID: sisteme-cu-semnale-de-curent
:END:
...
* Analiza retelei
:PROPERTIES:
:CUSTOM_ID: analiza-retelei
:END:

** Ce înseamnă analiza unei reţele
:PROPERTIES:
:CUSTOM_ID: ce-inseamna-analiza-unei-retele
:END:
...
:PROPERTIES:
:CUSTOM_ID: metoda-ramurii-de-curent
:END:
...
:PROPERTIES:
:CUSTOM_ID: metoda-buclei-de-curent
:END:
...
:PROPERTIES:
:CUSTOM_ID: metoda-nodului-de-tensiune
:END:
...
:PROPERTIES:
:CUSTOM_ID: teorema-superpozitiei
:END:
...
:PROPERTIES:
:CUSTOM_ID: teorema-lui-thevenin
:END:
...
:PROPERTIES:
:CUSTOM_ID: echivalenta-teoremelor-thevenin-norton
:END:
...
:PROPERTIES:
:CUSTOM_ID: teorema-lui-millman-revizuita
:END:
...
:PROPERTIES:
:CUSTOM_ID: teorema-transferului-maxim-de-putere
:END:
...
:PROPERTIES:
:CUSTOM_ID: transformarea-triunghi-stea-si-stea-triunghi
:END:
...
:PROPERTIES:
:CUSTOM_ID: activitatea-electronilor-in-reactiile-chimice
:END:
...
:PROPERTIES:
:CUSTOM_ID: constructia-bateriilor-electrice
:END:
...
:PROPERTIES:
:CUSTOM_ID: capacitatea-bateriilor
:END:
...
:PROPERTIES:
:CUSTOM_ID: consideratii-practice
:END:
...
:PROPERTIES:
:CUSTOM_ID: fizica-conductorilor
:END:

** Introducere fizica conductorilor
:PROPERTIES:
:CUSTOM_ID: introducere-fizica-conductorilor
:END:
...
:PROPERTIES:
:CUSTOM_ID: marimea-si-amperajul-conductorilor
:END:
...
:PROPERTIES:
:CUSTOM_ID: rezistivitatea-si-conductibilitatea-electrica
:END:
...
:PROPERTIES:
:CUSTOM_ID: coeficientul-de-temperatura-al-rezistentei
:END:
...
:PROPERTIES:
:CUSTOM_ID: supraconductibilitatea
:END:
...
#+CAPTION: curentul electric poate fi susţinut pentru o perioadă de timp practic
...
:PROPERTIES:
:CUSTOM_ID: strapungerea-dielectricului
:END:
...
* Condensatorul
:PROPERTIES:
:CUSTOM_ID: condensatorul
:END:

** Câmpuri şi capacitatea electrică
:PROPERTIES:
:CUSTOM_ID: campuri-si-capacitatea-electrica
:END:
...
:PROPERTIES:
:CUSTOM_ID: relatia-tensiune-curent-pentru-condensator
:END:
...
:PROPERTIES:
:CUSTOM_ID: factori-ce-afecteaza-capacitatea-electrica
:END:
...
:PROPERTIES:
:CUSTOM_ID: conectarea-condensatorilor-in-serie-si-paralel
:END:
...
:PROPERTIES:
:CUSTOM_ID: condensatorul-consideratii-practice
:END:
...
#+CAPTION: simbolul condensatorului electrolitic
[[./poze/00301.png]]
...
* Electromagnetism
:PROPERTIES:
:CUSTOM_ID: electromagnetism
:END:

** Magneţi permanenţi
:PROPERTIES:
:CUSTOM_ID: magneti-permanenti
:END:
...
:PROPERTIES:
:CUSTOM_ID: unitati-de-masura-ale-campului-magnetic
:END:
...
:PROPERTIES:
:CUSTOM_ID: permeabilitatea-si-saturatia
:END:
...
:PROPERTIES:
:CUSTOM_ID: inductanta-mutuala.-transformatorul
:END:
...
:PROPERTIES:
:CUSTOM_ID: campul-magnetic-si-inductanta
:END:
...
:PROPERTIES:
:CUSTOM_ID: relatia-tensiune-curent-pentru-bobina
:END:
...
:PROPERTIES:
:CUSTOM_ID: factori-ce-influenteaza-inductanta
:END:
...
:PROPERTIES:
:CUSTOM_ID: bobine-serie-si-paralel
:END:
...
:PROPERTIES:
:CUSTOM_ID: bobina-consideratii-practice
:END:
...
* Constante de timp
:PROPERTIES:
:CUSTOM_ID: constante-de-timp
:END:

** Răspunsul tranzitoriu al condensatorului
:PROPERTIES:
:CUSTOM_ID: raspunsul-tranzitoriu-al-condensatorului
:END:
...
:PROPERTIES:
:CUSTOM_ID: raspunsul-tranzitoriu-al-bobinei
:END:
...
:PROPERTIES:
:CUSTOM_ID: calcularea-tensiunii-si-a-curentului
:END:
...
:PROPERTIES:
:CUSTOM_ID: cazuri-speciale-de-calcul
:END:
...
:PROPERTIES:
:CUSTOM_ID: rezolvarea-circuitului-pentru-variabila-timp
:END:
