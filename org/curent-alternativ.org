...
* Bazele teoriei
:PROPERTIES:
:CUSTOM_ID: bazele-teoriei
:END:

** Ce este curentul alternativ
:PROPERTIES:
:CUSTOM_ID: ce-este-curentul-alternativ
:END:
...
#+CAPTION: cuplul reprezintă tensiunea şi viteza reprezintă curentul
[[./poze/02005.png]]
...
#+CAPTION: folosirea transformatoarelor ridicătoare şi coborâtoare de tensiune
[[./poze/02007.png]]
...
:PROPERTIES:
:CUSTOM_ID: forme-de-unda-in-curent-alternativ
:END:
...
:PROPERTIES:
:CUSTOM_ID: amplitudinea-curentului-alternativ
:END:
...
#+CAPTION: o amplitudine de vârf de 10 V, asupra aceleiaşi sarcini sunt diferite
[[./poze/02013.png]]
...
#+CAPTION: de undă sinusoidală, luând în considerare şi semnul acestora, este zero
[[./poze/02412.png]]
...
#+CAPTION: unei forme de undă sinusoidală, considerând toate punctele de pe grafic
...
#+CAPTION: valoarea efectivă a tensiunii şi a curentului alternativ
[[./poze/02015.png]]
...
#+CAPTION: vârf, vârf la vârf, medii practice şi valorii efective pentru formele de
...
#+CAPTION: coeficienţi pentru calcularea relaţiei dintre valorile de vârf, vârf la
#+CAPTION: vârf, medii şi efective
[[./poze/02017.png]]

** Rezolvarea circuitelor simple de curent alternativ
:PROPERTIES:
:CUSTOM_ID: rezolvarea-circuitelor-simple-de-curent-alternativ
:END:
...
:PROPERTIES:
:CUSTOM_ID: fazele-curentului-alternativ
:END:
...
#+CAPTION: pentru vizualizarea defazajului dintre două forme de undă sinusoidale -
...
:PROPERTIES:
:CUSTOM_ID: principii-ale-undelor-radio
:END:
...
* Numere complexe
:PROPERTIES:
:CUSTOM_ID: numere-complexe
:END:

** Introducere
:PROPERTIES:
:CUSTOM_ID: introducere-numere-complexe
:END:
...
:PROPERTIES:
:CUSTOM_ID: vectori-si-forme-de-unda-in-curent-alternativ
:END:
...
#+CAPTION: ajutorul vectorilor, unde lungimea vectorului reprezintă amplitudinea
#+CAPTION: undei
[[./poze/02031.png]]
...
#+CAPTION: reprezentarea formelor de undă în curent alternativ cu
#+CAPTION: ajutorul vectorilor; faze şi relaţii pentru defazaje de 0, 90, -90
...
:PROPERTIES:
:CUSTOM_ID: adunarea-simpla-a-vectorilor
:END:
...
#+CAPTION: aceeiaşi fază sunt conectate în serie, tensiunile lor se adună asemenea
...
#+CAPTION: polaritatea schimbată şi faza modificată cu 180 de grade faţă de
#+CAPTION: cealaltă
[[./poze/02266.png]]

** Adunarea complexă a vectorilor
:PROPERTIES:
:CUSTOM_ID: adunarea-complexa-a-vectorilor
:END:
...
:PROPERTIES:
:CUSTOM_ID: notatia-polara-si-rectangulara-a-numerelor-complexe
:END:
...
:PROPERTIES:
:CUSTOM_ID: aritmetica-numerelor-complexe
:END:
...
:PROPERTIES:
:CUSTOM_ID: clarificari-legate-de-polaritatea-curentului-alternativ
:END:
...
* Reactanta inductiva
:PROPERTIES:
:CUSTOM_ID: reactanta-inductiva
:END:

** Circuite rezistive în curent alternativ
:PROPERTIES:
:CUSTOM_ID: circuite-rezistive-in-curent-alternativ
:END:
...
#+CAPTION: unui circuit de curent alternativ pur rezistiv
[[./poze/02055.png]]
...
:PROPERTIES:
:CUSTOM_ID: circuite-inductive-in-curent-alternativ
:END:
...
:PROPERTIES:
:CUSTOM_ID: circuite-rezistiv-inductive-serie.-impedanta
:END:
...
#+CAPTION: electric rezistiv-inductiv serie în curent alternativ
[[./poze/02063.png]]
...
:PROPERTIES:
:CUSTOM_ID: circuite-rezistiv-inductive-paralel-in-curent-alternativ
:END:
...
:PROPERTIES:
:CUSTOM_ID: reactanta-capacitiva
:END:

** Circuite pur rezistive
:PROPERTIES:
:CUSTOM_ID: circuite-pur-rezistive
:END:
...
:PROPERTIES:
:CUSTOM_ID: circuite-pur-capacitive
:END:
...
#+CAPTION: condensatorului şi rata de variaţie a tensiunii la bornele acestuia
[[./poze/12041.png]]
...
:PROPERTIES:
:CUSTOM_ID: circuite-rezistiv-capacitive-serie
:END:
...
:PROPERTIES:
:CUSTOM_ID: circuite-rezistiv-capacitive-paralel
:END:
...
* Reactanta RLC
:PROPERTIES:
:CUSTOM_ID: reactanta-rlc
:END:

** R, X şi Z - recapitulare
:PROPERTIES:
:CUSTOM_ID: r-x-si-z-recapitulare
:END:
...
:PROPERTIES:
:CUSTOM_ID: circuite-rlc-paralel
:END:
...
:PROPERTIES:
:CUSTOM_ID: circuite-rlc-serie-paralel
:END:
...
:PROPERTIES:
:CUSTOM_ID: susceptanta-si-admitanta
:END:
...
#+CAPTION: încărcat la tensiunea de vârf, bobina descărcată, curent zero
[[./poze/02086.png]]
...
#+CAPTION: tensiunii; descărcarea bobine, descreşterea curentului
[[./poze/02089.png]]
...
#+CAPTION: pendul electric - încărcarea condensatorului, creşterea
#+CAPTION: tensiunii; descărcarea bobinei, descreşterea curentului
[[./poze/02093.png]]
...
:PROPERTIES:
:CUSTOM_ID: aplicatii-ale-rezonantei
:END:
...
:PROPERTIES:
:CUSTOM_ID: rezonanta-serie-paralel-antirezonanta
:END:
...
[[./poze/02103.png]] 
#+CAPTION: circuit LC paralel; rezistor serie cu
#+CAPTION: condensatorul; graficul variaţiei curentului cu frecvenţa
[[./poze/22009.png]]
...
* Frecvente combinate
:PROPERTIES:
:CUSTOM_ID: frecvente-combinate
:END:

** Introducere
:PROPERTIES:
:CUSTOM_ID: introducere-frecvente-combinate
:END:
...
#+CAPTION: cuplaj inductiv şi cuplaj capacitiv între un circuit de
#+CAPTION: curent continuu şi unul de curent alternativ; folosirea cablurilor
#+CAPTION: răsucite şi ecranate pentru reducerea efectelor cuplajelor
[[./poze/02303.png]]
...
:PROPERTIES:
:CUSTOM_ID: forme-de-unda-dreptunghiulare
:END:
...
[[./poze/22016.png]] 
#+CAPTION: graficul formei de undă sinusoidale fundamentale, la 50 Hz, plus
...
#+CAPTION: triunghiulară şi pur sinusoidală) - simetrice faţă de axa orizontală
[[./poze/02293.png]]
...
#+CAPTION: forme de undă ce nu conţin armonici pare (dreptunghiulară,
#+CAPTION: triunghiulară şi pur sinusoidală plus o componentă de curent continuu) -
...
:PROPERTIES:
:CUSTOM_ID: efecte-asupra-circuitelor
:END:
...
#+CAPTION: circuit electric alimentat printr-o combinaţie de frecvenţe
#+CAPTION: de 60 Hz, respectiv 90 Hz - analiza circuitului doar cu sursa de
...
#+CAPTION: curent alternativ într-un circuit de curent continuu sensibil
[[./poze/02300.png]]
...
#+CAPTION: zgomotul inductiv şi capacitiv introdus de un circuit de
#+CAPTION: curent alternativ într-un circuit de curent continuu sensibil; folosirea
...
#+CAPTION: filtru trece-jos capacitiv şi un filtru trece-sus capacitiv conectate în
#+CAPTION: serie
[[./poze/02121.png]]
...
#+CAPTION: trece-bandă compus dintr-un filtru trece-jos capacitiv şi un filtru
...
#+CAPTION: în paralel a unui filtru trece-jos cu un filtru trece-sus
[[./poze/02261.png]]
...
#+CAPTION: format din conectarea în paralel a unui filtru trece-jos cu un filtru
#+CAPTION: trece-sus
[[./poze/02123.png]]
...
#+CAPTION: impedanţele de intrare şi ieşire egalate; diagrama Bode
[[./poze/02517.png]]
...
* Transformatorul
:PROPERTIES:
:CUSTOM_ID: transformatorul
:END:

** Inductanţa mutuală şi modul de funcţionare
:PROPERTIES:
:CUSTOM_ID: inductanta-mutuala-si-modul-de-functionare
:END:
...
#+CAPTION: formele de undă ale tensiunii induse, a curentului prin
#+CAPTION: înfăşurare şi a fluxului magnetic; forma de undă a curentului este
#+CAPTION: distorsionată datorită saturaţiei miezului feromagnetic
[[./poze/02336.png]]
...
#+CAPTION: (înfăşurarea primară şi secundară) şi un miez feromagnetic comun celor
#+CAPTION: două
[[./poze/02131.png]]
...
:PROPERTIES:
:CUSTOM_ID: transformatorul-ridicator-si-coborator-de-tensiune
:END:
...
:PROPERTIES:
:CUSTOM_ID: tipuri-de-infasurari
:END:
...
#+CAPTION: prize; utilizarea comutatoarelor pentru alegerea raportului de
...
#+CAPTION: se deplasează pe înfăşurarea secundară expusă a transformatorului
[[./poze/02144.png]]
...
#+CAPTION: înfăşurarea secundară conectată în serie pentru amplificarea tensiunii
[[./poze/02147.png]] 
#+CAPTION: folosirea unui autotransformator
#+CAPTION: coborâtor de tensiune cu înfăşurarea secundară conectată în serie pentru
...
* Circuite polifazate
:PROPERTIES:
:CUSTOM_ID: circuite-polifazate
:END:

** Sisteme de alimentare monofazate
:PROPERTIES:
:CUSTOM_ID: sisteme-de-alimentare-monofazate
:END:
...
#+CAPTION: schema electrică a unui circuit monofazat simplu; sarcinile
#+CAPTION: sunt conectate în serie; adăugarea unui conductor neutru
[[./poze/02168.png]] 
#+CAPTION: calcule matematice
[[./poze/12111.png]]
...
#+CAPTION: înfăşurarea secundară pentru alimentarea unui sistem de alimentare în
...
:PROPERTIES:
:CUSTOM_ID: sisteme-de-alimentare-trifazate
:END:
...
#+CAPTION: sistem de alimentare folosind două surse de tensiune de 120 V
#+CAPTION: defazate între ele cu un unghi de 120 de grade; calcului curentului prin
#+CAPTION: neutru
[[./poze/02172.png]] 
#+CAPTION: calcule matematice
[[./poze/12114.png]]
...
#+CAPTION: defazate între ele cu un unghi de 120 de grade; folosirea neutrului pe
...
#+CAPTION: corpuri de iluminat pentru detectarea secvenţei fazelor unui sistem de
...
:PROPERTIES:
:CUSTOM_ID: functionarea-motorului-polifazat
:END:
...
#+CAPTION: între curenţii înfăşurărilor de pornire a motorului de curent alternativ
#+CAPTION: monofazat
[[./poze/02189.png]]
...
#+CAPTION: analogie pentru funcţionarea motorului de curent alternativ
#+CAPTION: trifazat; secvenţa fazelor unui set de becuri; rearanjarea acestora
...
:PROPERTIES:
:CUSTOM_ID: configuratii-stea-si-triunghi-trifazate
:END:
...
#+CAPTION: tensiunile/curenţii de fază într-o sistem de tensiuni trifazate în
...
#+CAPTION: conexiunea unui sistem alternativ trifazat în configuraţie
#+CAPTION: triunghi; deschiderea circuitului la unul din noduri pentru asigurarea
#+CAPTION: faptului că nu există circulaţie de curent prin bucla formată din
#+CAPTION: laturile triunghiului; tensiunea măsurată între cele două ramuri trebuie
#+CAPTION: să fie zero
[[./poze/02198.png]]
...
#+CAPTION: configuraţie triunghi, nu afectează tensiunea de linie şi de fază;
#+CAPTION: singura diferenţă este creşterea curentului în înfăşurările funcţionale
#+CAPTION: rămase
[[./poze/02200.png]]
...
#+CAPTION: defectarea unei dintre înfăşurări, într-un sistem trifazat în
#+CAPTION: configuraţie stea, alimentând o sarcină în configuraţie triunghi
[[./poze/02201.png]]
...
#+CAPTION: defectarea unei dintre înfăşurări, într-un sistem trifazat în
#+CAPTION: configuraţie stea, alimentând o sarcină în configuraţie stea
[[./poze/02202.png]]
...
:PROPERTIES:
:CUSTOM_ID: transformatorul-trifazat
:END:
...
#+CAPTION: stea, fie triunghi; acelaşi lucru este valabil şi pentru intrările A2,
#+CAPTION: B2, C2
[[./poze/02205.png]]
...
#+CAPTION: triunghi-triunghi - Y-Y; exemplificare cu ajutorul a trei
...
#+CAPTION: conectarea unui transformator trifazat în configuraţie
#+CAPTION: stea-triunghi - Y-Δ; exemplificare cu ajutorul a trei transformatoare
...
#+CAPTION: conectarea unui transformator trifazat în configuraţie
#+CAPTION: triunghi-stea - Δ-Y; exemplificare cu ajutorul a trei transformatoare
#+CAPTION: monofazate echivalente
[[./poze/02208.png]]
...
#+CAPTION: conectarea unui transformator trifazat în configuraţie
#+CAPTION: triunghi-triunghi - Δ-Δ; exemplificare cu ajutorul a trei
#+CAPTION: transformatoare monofazate echivalente
[[./poze/02209.png]]
...
#+CAPTION: conectarea unui transformator trifazat în configuraţie
#+CAPTION: triunghi-triunghi deschisă- Δ-Δ; exemplificare cu ajutorul a două
#+CAPTION: transformatoare monofazate echivalente
[[./poze/02210.png]]
...
* Factorul de putere
:PROPERTIES:
:CUSTOM_ID: factorul-de-putere
:END:

** Puterea în circuitele de curent alternativ rezistive şi reactive
:PROPERTIES:
:CUSTOM_ID: puterea-in-circuitele-de-curent-alternativ-rezistive-si-reactive
:END:
...
#+CAPTION: circuit monofazat de curent alternativ cu sarcină pur rezistivă
[[./poze/02055.png]]
...
#+CAPTION: curentului şi puterii într-un circuit monofazat de curent alternativ cu
...
#+CAPTION: Formele de undă ale tensiunii, curentului şi puterii într-un
#+CAPTION: circuit monofazat de curent alternativ cu sarcină rezistiv-inductivă
[[./poze/02214.png]]
...
:PROPERTIES:
:CUSTOM_ID: puterea-reala-reactiva-si-aparenta
:END:
...
#+CAPTION: aparentă, în funcţie de rezistenţă, reactanţă şi impedanţă
[[./poze/12123.png]]
...
#+CAPTION: calcularea puterii reale, reactive şi aparente într-un
#+CAPTION: circuit electric de curent alternativ pur rezistiv-inductiv
[[./poze/02217.png]]
...
:PROPERTIES:
:CUSTOM_ID: calcularea-si-corectarea-factorului-de-putere
:END:
...
#+CAPTION: condensator în paralel cu sarcină rezistiv-inductivă
[[./poze/02219.png]] 
#+CAPTION: calcule matematice
[[./poze/12126.png]]
...
:PROPERTIES:
:CUSTOM_ID: corectarea-practica-a-factorului-de-putere
:END:
...
* Motoare electrice
:PROPERTIES:
:CUSTOM_ID: motoare-electrice
:END:

** Scurtă introducere a motoarelor electrice
:PROPERTIES:
:CUSTOM_ID: scurta-introducere-a-motoarelor-electrice
:END:
...
:PROPERTIES:
:CUSTOM_ID: histereza-si-curentii-turbionari
:END:
...
:PROPERTIES:
:CUSTOM_ID: semnale-analogice-si-digitale
:END:
...
:PROPERTIES:
:CUSTOM_ID: linii-electrice-lungi
:END:

** Circuitele electrice şi viteza luminii
:PROPERTIES:
:CUSTOM_ID: circuitele-electrice-si-viteza-luminii
:END:
...
#+CAPTION: circuit electric simplu, format dintr-o baterie, o lampă şi
#+CAPTION: un întrerupător; conductori de 300.000 de km lungime
[[./poze/02353.png]]
...
#+CAPTION: pornirea trenului de pe loc şi deplasarea vagoanelor
[[./poze/02354.png]]
...
:PROPERTIES:
:CUSTOM_ID: impedanta-caracteristica
:END:
...
#+CAPTION: circuit electric simplu format din baterie şi întrerupător şi
#+CAPTION: conductori de lungime infinită; apariţia capacităţilor parazite între
...
#+CAPTION: circuit electric simplu format din baterie şi întrerupător şi
#+CAPTION: conductori de lungime infinită; capacităţile şi inductanţele parazite
[[./poze/02357.png]] 
...
[[./poze/02361.png]] 
#+CAPTION: linie electrică lungă neîncărcată; închiderea întrerupătorului şi
#+CAPTION: propagarea undei
[[./poze/02362.png]] 
#+CAPTION: linie electrică lungă
#+CAPTION: neîncărcată; închiderea întrerupătorului şi propagarea undei cu
...
:PROPERTIES:
:CUSTOM_ID: linii-electrice-finite
:END:
...
:PROPERTIES:
:CUSTOM_ID: linii-electrice-lungi-si-linii-electrice-scurte
:END:
...
:PROPERTIES:
:CUSTOM_ID: unde-stationare-si-rezonanta
:END:
