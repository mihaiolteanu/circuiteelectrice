...
* Amplificatoare
:PROPERTIES:
:CUSTOM_ID: amplificatoare
:END:

** Circuite electrice şi circuite electronice
:PROPERTIES:
:CUSTOM_ID: circuite-electrice-si-circuite-electronice
:END:
...
:PROPERTIES:
:CUSTOM_ID: elemente-active-si-elemente-pasive
:END:
...
:PROPERTIES:
:CUSTOM_ID: factorul-de-amplificare
:END:
...
#+CAPTION: etaje; amplificarea finală este produsul amplificărilor individuale
[[./poze/03169.png]]
...
#+CAPTION: formă de raport şi aceleaşi pierderi de putere exprimate în beli
[[./poze/13029.png]]
...
#+CAPTION: tabel; comparaţia între pierderile de putere exprimate sub
#+CAPTION: formă de raport şi aceleaşi pierderi de putere exprimate în decibeli
[[./poze/13030.png]]

* Fizica semiconductorilor
:PROPERTIES:
:CUSTOM_ID: fizica-semiconductorilor
:END:

** Fizica cuantică
:PROPERTIES:
:CUSTOM_ID: fizica-cuantica
:END:
...
#+CAPTION: unei foiţe de aur cu particule Alfa încărcate pozitiv
[[./poze/03389.png]]
...
#+CAPTION: reprezentarea substraturilor atomului de Ag; notaţia spectroscopică
[[./poze/03392.png]]
...
:PROPERTIES:
:CUSTOM_ID: valenta-si-structura-cristalina
:END:
...
#+CAPTION: valenţă, electron care este cedat în reacţia cu alte elemente chimice
[[./poze/03394.png]]
...
#+CAPTION: valenţă, prin urmare, acestea acceptă un electron pentru completarea
...
#+CAPTION: stratul de valentă, prin urmare, aceste elemente nu cedează şi nici nu
#+CAPTION: acceptă electroni, ceea ce înseamnă ca nu pot participa la reacţii
#+CAPTION: chimice
[[./poze/03396.png]]
...
#+CAPTION: de valenţă; aceste elemente sunt studiate în electronică pentru
...
:PROPERTIES:
:CUSTOM_ID: teoria-benzilor-de-energie
:END:
...
#+CAPTION: acceptorului de tip P (bor) şi a siliciului (pentru referinţă)
#+CAPTION: (b)impuritatea donorului de tip N crează electroni liberi;
#+CAPTION: (c)impuritatea acceptorului de tip P crează goluri
 [[./poze/03404.png]]
...
#+CAPTION: tip N; (b) (a) deplasarea electronilor într-un material semiconductor de
#+CAPTION: tip P
[[./poze/03407.png]]

** Joncţiunea P-N
:PROPERTIES:
:CUSTOM_ID: jonctiunea-p-n
:END:
...
#+CAPTION: proprietate remarcabilă; (b) un singur cristal dopat atât cu impurităţi
#+CAPTION: P cât şi cu impurităţi N duce la formarea unei bariere de potenţial
[[./poze/03408.png]]
...
#+CAPTION: (c) simbolul diodei; (d) modul de împachetare al unei diode
[[./poze/03301.png]]
...
:PROPERTIES:
:CUSTOM_ID: tranzistorul-bipolar-cu-jonctiune-bjt
:END:
...
#+CAPTION: joncţiunii colector-bază: (a) polarizarea directă a joncţiunii
#+CAPTION: bază-emitor duce la (b) apariţia unui curent de bază mic şi a unui
...
#+CAPTION: emitor: (a) pierduţi datorită recombinării cu golurile bazei; (b) se
#+CAPTION: deplasează spre contactul bazei şi înspre borna pozitivă a sursei de
#+CAPTION: aplimentare; (c) moajoritatea trec prin zona îngustă de golire
#+CAPTION: bază-colector înspre colector; (d) electronii sunt atraşi de câmpul
...
#+CAPTION: (b) simbol; (c) secţiune transversală într-un circuit integrat
[[./poze/03302.png]]
...
:PROPERTIES:
:CUSTOM_ID: tranzistorul-cu-efect-de-camp-jfet
:END:
...
#+CAPTION: (a) zona de golire a porţii; (b) creşterea zonei de golire la
#+CAPTION: polarizarea inversă; (c) zona de golire creşte tot mai mult cu creşterea
#+CAPTION: tensiunii de polarizare inversă; (d) blocarea canalului sursă-drenă
#+CAPTION: (S-D) datorită creşterii tensiunii de polarizare inversă
[[./poze/03416.png]]
...
#+CAPTION: tip N: (a) secţiune transversală; (b) simbolul schematic
[[./poze/03417.png]]
...
#+CAPTION: surselor de alimentare sunt inversată faţă de tranzistorul cu canal de
#+CAPTION: tip N; (b) simbolul schematic - direcţia săgeţii porţii este inversată
[[./poze/03418.png]]
...
#+CAPTION: transversală printr-un dispozitiv discret; (b) simbolul schematic; (c)
#+CAPTION: secţiune transversală printr-un circuit integrat
[[./poze/03303.png]]

** Tranzistorul cu efect de câmp cu poartă izolată (MOSFET)
:PROPERTIES:
:CUSTOM_ID: tranzistorul-cu-efect-de-camp-cu-poarta-izolata-mosfet
:END:
...
#+CAPTION: modul de dopare al straturilor; (b) circuit cu tranzistoare bipolare cu
...
#+CAPTION: al redresorului controlat pe bază de siliciu (SCR) (c) simbolul
...
:PROPERTIES:
:CUSTOM_ID: principiul-de-functionare
:END:
...
#+CAPTION: diodei - trecerea curentului este permisă; (b) dioda este polarizată
...
#+CAPTION: (a) supapa este deschisă şi permite trecerea fluidului; (b) supapa este
...
#+CAPTION: diodă: (a) polarizarea directă a diodei; (b) polarizarea inversă a
#+CAPTION: diodei
[[./poze/03249.png]]
...
:PROPERTIES:
:CUSTOM_ID: verificarea-diodei-cu-ajutorul-ohmmetrului
:END:
...
#+CAPTION: măsură: (a) rezistenţa mică între anod şi catod indică polarizarea
#+CAPTION: directă a diodei; (b) inversarea sondelor aparatului de măsură duce la
#+CAPTION: polarizarea inversă a diodei, indicată de rezistenţa foarte mare
#+CAPTION: (infinită)
 [[./poze/03254.png]]
...
#+CAPTION: folosind un multimetru digital echipat cu funcţia de verificare a
#+CAPTION: diodelor
[[./poze/03256.png]]
...
#+CAPTION: un aparat de măsură (voltmetru), o baterie şi un rezistor: (a) schema
#+CAPTION: electrică; (b) schema practică
[[./poze/03257.png]]

** Parametrii diodei
:PROPERTIES:
:CUSTOM_ID: parametrii-diodei
:END:
...
#+CAPTION: jumătăţi a periodei tensiunii de alimentare alternative
[[./poze/03261.png]]
...
#+CAPTION: de a doua jumătăţi a periodei tensiunii de alimentare alternative
[[./poze/03262.png]]
...
#+CAPTION: - toate diodele sunt poziţionate orizontal şi indică aceeiaşi direcţie
[[./poze/03266.png]]
...
#+CAPTION: punte conectate în paralel, folosind un transformator primar şi două
#+CAPTION: secundare în configuraţie Y-Y, respectiv Y-Δ
[[./poze/03270.png]]

** Dioda Zener
:PROPERTIES:
:CUSTOM_ID: dioda-zener
:END:
...
#+CAPTION: diodă (0.7 V); (b) zece diode conectate în serie (7 V)
[[./poze/03284.png]]
...
#+CAPTION: siliciu este aproximativ 100 V; (b) simbolul diodei Zener
[[./poze/03285.png]]
...
#+CAPTION: 1.000 Ω; (b) calcularea căderilor de tensiune şi ale curenţilor
[[./poze/03289.png]]
...
#+CAPTION: (a) stabilizator de tensiune cu diodă zener şi un rezistor de
#+CAPTION: 1.000 Ω; conectarea unei sarcini de 500 Ω în paralel cu dioda zener
[[./poze/03291.png]]
...
#+CAPTION: (a) stabilizator de tensiune cu diodă zener şi un rezistor de
#+CAPTION: 100 kΩ în serie; conectarea unei sarcini de 500 Ω în paralel cu dioda
#+CAPTION: zener
[[./poze/03292.png]]
...
* Tranzistorul
:PROPERTIES:
:CUSTOM_ID: tranzistorul
:END:

** Introducere
:PROPERTIES:
:CUSTOM_ID: tranzistorul-introducere
:END:
...
#+CAPTION: secţiune transversală PNP; (c) simbolul NPN; (d) secţiune transversală
#+CAPTION: NPN
[[./poze/03071.png]]
...
:PROPERTIES:
:CUSTOM_ID: tranzistorul-pe-post-de-intrerupator
:END:
...
#+CAPTION: introducerea în circuit a unui tranzistor NPN în locul întrerupătorului;
#+CAPTION: (c) introducerea în circuit a unui tranzistor PNP în locul
...
#+CAPTION: tranzistor blocat; (b) tranzistor în stare de conducţie
[[./poze/03078.png]]
...
:PROPERTIES:
:CUSTOM_ID: verificarea-tranzistorului-cu-ohmmetrul
:END:
...
#+CAPTION: joncţiunile bază-emitor şi bază-colector sunt polarizate direct,
#+CAPTION: rezistenţa este mică; (b) joncţiunile bază-emitor şi bază-colector sunt
...
#+CAPTION: folosi pentru explicare funcţionării tranzistorilor în circuitele reale
[[./poze/03087.png]]

** Zona activă de funcţionare a tranzistorului
:PROPERTIES:
:CUSTOM_ID: zona-activa-de-functionare-a-tranzistorului
:END:
...
#+CAPTION: tranzistorului între 0 V şi 2 V şi un curent de alimentare constant de
#+CAPTION: 20 µA; curentul prin colector este un curent constant de 2 mA
[[./poze/23000.png]]
...
#+CAPTION: variaţia curent-tensiune pentru o tensiune de alimentare a
#+CAPTION: tranzistorului între 0 V şi 50 V şi un curent de alimentare constant de
#+CAPTION: 20 µA; curentul prin colector este şi de această dată un curent constant
#+CAPTION: de 2 mA
[[./poze/23001.png]]
...
#+CAPTION: variaţia curent-tensiune pentru o tensiune de alimentare a
#+CAPTION: tranzistorului între 0 V şi 50 V şi un curent de alimentare variabil
#+CAPTION: între 15 µA şi 75 µA; în acest caz există şi alte curbe de variaţie
...
:PROPERTIES:
:CUSTOM_ID: amplificator-cu-tranzistor-in-conexiune-emitor-comun
:END:
...
#+CAPTION: format dintr-o celulă solară şi un ampermetru pentru măsurarea
...
#+CAPTION: ajutorului unui tranzistor în conexiune emitor-comun
[[./poze/03094.png]]
...
#+CAPTION: amplificator cu tranzistor în conexiune emitor comun legat la
#+CAPTION: difuzor şi acţionat cu ajutorul unui semnal audio; circuitul practic
[[./poze/03098.png]]
...
#+CAPTION: amplificator cu tranzistor în conexiune emitor comun legat la
#+CAPTION: difuzor şi acţionat cu ajutorul unui semnal audio; formele de undă ale
#+CAPTION: tensiunii de intrare şi a curentului emitor-colector (prin difuzor)
[[./poze/23004.png]]
...
#+CAPTION: polarizarea directă a jocţiunii bază-emitor pe toată perioada semnalului
#+CAPTION: de intrare
[[./poze/03099.png]]
...
#+CAPTION: puncte critice ale unui amplificator cu tranzistor în conexiune
...
#+CAPTION: graficul formelor de undă a tensiunii pe difuzor (albastru)
#+CAPTION: şi al tensiunii de intrare a tranzistorului (roşu), pentru o sarcină de
#+CAPTION: 30 Ω în loc de 8 Ω
[[./poze/23007.png]]
...
:PROPERTIES:
:CUSTOM_ID: amplificator-cu-tranzistor-in-conexiune-colector-comun
:END:
...
#+CAPTION: configuraţia amplificatorului cu tranzistor în conexiune
#+CAPTION: colector comun; circuit practic
[[./poze/03103.png]]
...
#+CAPTION: configuraţia amplificatorului cu tranzistor în conexiune
#+CAPTION: colector comun; variaţia tensiune ieşire - tensiune intrare
[[./poze/23009.png]]
...
#+CAPTION: configuraţia amplificatorului cu tranzistor în conexiune
#+CAPTION: colector comun; modelul diodă-sursă-de-tensiune pentru explicarea
#+CAPTION: comportamentului amplificatorului
[[./poze/03104.png]]
...
#+CAPTION: configuraţia amplificatorului cu tranzistor în conexiune
#+CAPTION: colector comun; adăugarea sursei de tensiune în curent continuu pentru
#+CAPTION: polarizarea corectă a tranzistorului
[[./poze/03105.png]]
...
#+CAPTION: amplificatorului colector comun
[[./poze/23010.png]]
...
#+CAPTION: configuraţia amplificatorului cu tranzistor în conexiune
#+CAPTION: colector comun; conectarea osciloscoapelor pentru vizualizarea formelor
#+CAPTION: de undă
[[./poze/03111.png]]
...
#+CAPTION: configuraţia amplificatorului cu tranzistor în conexiune
#+CAPTION: colector comun; calcularea factorului de amplificare în curent
[[./poze/13020.png]]
...
#+CAPTION: conexiune colector comun;
[[./poze/03113.png]]
...
#+CAPTION: tranzistor în conexiune colector comun pentru acţionarea sarcinii
[[./poze/03107.png]]
...
:PROPERTIES:
:CUSTOM_ID: amplificator-cu-tranzistor-in-conexiune-baza-comuna
:END:
...
:PROPERTIES:
:CUSTOM_ID: amplificatoare-clasa-a-b-ab-c-si-d
:END:
...
:PROPERTIES:
:CUSTOM_ID: punctul-static-de-functionare-al-tranzistorului
:END:
...
#+CAPTION: punctul static de funcţionare al amplificatorului clasa A;
#+CAPTION: modificarea pantei dreptei de sarcină prin creşterea valorii rezistenţei
#+CAPTION: sarcinii
[[./poze/03146.png]]
...
#+CAPTION: punctul static de funcţionare al amplificatorului clasa A;
#+CAPTION: adăugarea unor curbe de sarcină suplimentară pentru observarea intrării
...
:PROPERTIES:
:CUSTOM_ID: metode-de-polarizare-ale-tranzistorului
:END:
...
#+CAPTION: în curent alternativ pentru polarizarea tranzistorului
[[./poze/03099.png]]
...
#+CAPTION: de curent alternativ şi circuitul divizor de tensiune pentru polarizarea
#+CAPTION: tranzistorului
[[./poze/03131.png]]
...
#+CAPTION: intrare al amplificatorului atunci când doar sursa de semnal de curent
...
#+CAPTION: aplicarea teoremei superpoziţiei; studierea circuitului de
#+CAPTION: intrare al amplificatorului atunci când doar sursa de tensiune de curent
#+CAPTION: continuu (bateria de 15 V) este conectată în circuit
[[./poze/03134.png]]
...
#+CAPTION: şi divizorul de tensiune; analiza circuitului folosind modelul
...
#+CAPTION: curent de ieşire nedistorsionat, semnal tipic pentru un amplificator de
#+CAPTION: clasa A
[[./poze/23014.png]]

** Cuplajul de intrare şi cuplajul de ieşire
:PROPERTIES:
:CUSTOM_ID: cuplajul-de-intrare-si-cuplajul-de-iesire
:END:
...
#+CAPTION: conectat la intrarea unui amplifcator folosind un condensator de cuplaj
...
#+CAPTION: pentru eliminarea componentei de curent continuu pe sarcină
[[./poze/03141.png]]
...
:PROPERTIES:
:CUSTOM_ID: amplificatoare-cu-reactie
:END:
...
:PROPERTIES:
:CUSTOM_ID: dispozitive-multijonctiune
:END:

** Histerezis
:PROPERTIES:
:CUSTOM_ID: histerezis
:END:
...
:PROPERTIES:
:CUSTOM_ID: tuburi-electronice-cu-descarcare-in-gaze
:END:
...
#+CAPTION: circuit cu dioda Shockley; graficul curent-tensiune;
#+CAPTION: tranzistorii rămân în starea de conducţie chiar şi după ce tensiunea
#+CAPTION: iniţială scade cu mult sub valoarea de străpungere iniţială
[[./poze/03200.png]]
...
#+CAPTION: circuit cu dioda Shockley; graficul curent-tensiune;
#+CAPTION: reintrarea tranzistorilor în stare de blocare pe măsură ce tensiunea
...
:PROPERTIES:
:CUSTOM_ID: amplificatorul-operational
:END:

** Introducere
:PROPERTIES:
:CUSTOM_ID: amplificatorul-operational-introducere
:END:
...
:PROPERTIES:
:CUSTOM_ID: amplificatorul-cu-potential-de-referinta-si-amplificatorul
:END:
diferenţial
...
#+CAPTION: tensiunii de referintă duce la modificarea factorului de umplere a undei
...
#+CAPTION: tensiune dintre cele două intrări este foarte aproape de zero volţi
[[./poze/03035.png]] 
...
:PROPERTIES:
:CUSTOM_ID: reactia-prin-divizor-de-tensiune
:END:
...
#+CAPTION: amplificatorului operaţional cu reacţie negativă divizată
[[./poze/13004.png]]
...
:PROPERTIES:
:CUSTOM_ID: amplificatorul-tensiune-curent
:END:
...
:PROPERTIES:
:CUSTOM_ID: circuite-sumatoare-si-de-mediere
:END:
...
:PROPERTIES:
:CUSTOM_ID: realizarea-unui-amplificator-diferential
:END:
...
:PROPERTIES:
:CUSTOM_ID: amplificatorul-de-instrumentatie
:END:
...
:PROPERTIES:
:CUSTOM_ID: circuite-de-derivare-si-integrare
:END:
